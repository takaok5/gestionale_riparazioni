...
- [ ] Failure invariants: negli ATDD verificare esplicitamente che, nei path di errore (es. AC-7), uno step di dettaglio successivo confermi stato invariato (`SPEDITO`).
