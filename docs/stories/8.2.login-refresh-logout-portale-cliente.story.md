...
**Then** the API returns HTTP `200` with top-level `accessToken`, `refreshToken`, and `profileSummary` containing `clienteId: 5`, `codiceCliente: CLI-000005`, `ragioneSociale: Cliente Test SRL`
