...
- [ ] ATDD: creare `packages/backend/src/__tests__/ordini-create-atdd.spec.ts` con scenari AC-1..AC-4 e assert puntuali su status/error code/error message/totale/numeroOrdine (incluso regex `^ORD-[0-9]{6}$`).
