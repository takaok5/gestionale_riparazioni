...
abstract class BaseService {
  ...
  bool needsReinitialization({Duration? maxAge}) {
    ...
    final age = AppDateUtils.getCurrentDateTime().difference(_initializationTime!);
  ...
  bool wasAccessedRecently({Duration? threshold}) {
    ...
    final timeSinceLastAccess = AppDateUtils.getCurrentDateTime()
        .difference(_lastAccessTime!);
